    ...
    <div class="container pt-4">
        <div class="headmenu position-relative bg-dark bg-gradient rounded pt-2">
            ...
            <div class="btn-toolbar mb-2 mb-md-0 position-absolute top-0 end-0 pt-2 ">
                ...
                <a href="{{ route('school.index') }}"><button type="button" class="btn btn-sm btn-outline-primary"><span
        ...
        <div class="campe bg-#f1f1f1f1"
            ...
            <form class="row g-3 needs-validation" novalidate action="{{ route('school.update', $school->id) }}"
                method="POST">
                @csrf
                @method('PUT')
                <div class="basicinfo">
                    <h4>School Add Form</h4>
                </div>
                <div class="col-md-4">

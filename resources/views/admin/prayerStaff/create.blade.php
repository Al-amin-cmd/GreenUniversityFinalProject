    ...
    <body>
        <div class="container pt-4">
            ...
            <div class="campe bg-#f1f1f1f1"
                ...
                <form class="row g-3 needs-validation" novalidate action="{{ route('prayerStaff.store') }}"
                    method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="basicinfo">
                        <h4>Prayer Staff Add Form</h4>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="mb-3 col-md-4">
                        <label for="validationCustom02" class="form-label">Prayer Place Name</label>
                        <select class="form-control" name="prayer_places_id" id="prayer_places_id">
                            <option value="">Select One</option>
                            @foreach ($prayerPlace as $key => $value)

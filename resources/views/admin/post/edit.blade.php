    ...
    <body>
        <div class="container pt-4">
            <div class="headmenu position-relative bg-dark bg-gradient rounded pt-2">
                <h2 class="h2 text-white">Post Edit</h2>
            ...
            <div class="campe bg-#f1f1f1f1"
                ...
                <form class="row g-3 needs-validation" novalidate action="{{ route('post.update', $posts) }}"
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea">{{ $posts->description }}</textarea>
                    ...
                    <div class="col-12 d-md-flex justify-content-md-center">
                        <button class="btn btn-primary m-1" type="submit">Update Data</button>
